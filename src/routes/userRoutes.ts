...
import { validateUserCreate, validateUserUpdate, validateUserById, validateUserIdAndToDoIdParams,checkUsersList, checkToDosListOfUser, checkToDosList, checkUserIsDisabled } from '../middleware';
...
router.get('/users/:id',checkUsersList,validateUserById,checkUserIsDisabled, userController.getUserById);
